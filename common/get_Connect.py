...
from common.read_yaml import open_yaml
import  PIL
class Login():
    def __init__(self,yaml_page_path,yaml_input_path):
        ...
        '''
        self.yaml_page_data = open_yaml(yaml_page_path)
        self.yaml_input_data = open_yaml(yaml_input_path)
    ...
    def get_ggh_connect(self,name,name_path):
        ...
        if you_path_pid is None:
            ...
            a=ggh_handle.capture_as_image()
            a.save(r"D:\pythonProject\pcclient_UI\testFile\123.png")
